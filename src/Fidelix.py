...
class Fidelix():
    ...
    def login(self, user = "user", password = "pass"):
        ...
        r = requests.post(url,data=data,headers=headers,allow_redirects=False, timeout=self.timeout)
    ...
    def read_value(self):
        ...
        r = requests.get(url,cookies=cookies,headers=headers,allow_redirects=False, timeout=self.timeout)
